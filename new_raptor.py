...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2024-10-08
        git sha              : $Format:%H$
        copyright            : (C) 2024 by Engin - deneme
...
class NewRaptor:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            #Buraya mesaj yazılırsa sadece 1 kere açılışta gözüküyor
    ...
    def evt_cmbSpecies_changed(self, species): #Swainsons Hawk seçildiğinde buffer distance gelen değeri kendimiz belirledik
